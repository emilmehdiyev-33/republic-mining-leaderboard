...
!lb — Same, shorter
!miner <name> — Show specific miner info (rank, jobs, completed, pending)
!m <name> — Same, shorter
...
!ranking — Same
!top100 — Same
!validator <name> — Detailed validator info (search by name, operator address, or wallet address)
!v <name> — Same, shorter
Network
!network — Full network overview (block, staked, validators, mining)
!net — Same, shorter
Alerts
!alert <name> — Set jail/unbond alert for a validator
...
Environment=NODE_URL=tcp://localhost:26657
Environment=PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
ExecStart=/usr/bin/python3 /root/republic_mining_bot.py
Restart=always
RestartSec=10
